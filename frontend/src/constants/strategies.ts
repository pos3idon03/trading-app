...
export const STRATEGIES: StrategyOption[] = [
  ...
  { value: 'aroon',                label: 'Aroon 52',                            group: 'Momentum' },
  { value: 'stoch_rsi',            label: 'Stochastic RSI',                      group: 'Momentum' },
...
export const DEFAULT_GRID_MAP: Record<string, Record<string, number[]>> = {
  ...
  aroon:                { period: [26, 52, 104], threshold: [30.0, 50.0, 70.0] },
  stoch_rsi:            { rsi_period: [10, 14, 21], stoch_period: [10, 14, 21], overbought: [0.75, 0.8, 0.85], oversold: [0.15, 0.2, 0.25] },
