...
_SKLEARN_TO_APP_PARAMS: dict[str, dict[str, str]] = {
    ...
    "ml_knn": {"n_neighbors": "knn_neighbors"},
    "ml_xgboost": {
...
def run_hyperparameter_search(
    ...
    grid = _param_grid(model_type, params)
    if not grid:
...
def _param_grid(model_type: str, params: dict) -> dict[str, list[Any]]:
    ...
    if model_type == "ml_knn":
        return {"n_neighbors": [3, 5, int(params.get("knn_neighbors", 7))]}
