...
from dtos.simulation_dto import CalibratedModelParams, JumpParams, VasicekParams
...
DEFAULT_CALIBRATION_YEARS = 2


def _default_start() -> datetime:
    return utcnow() - timedelta(days=DEFAULT_CALIBRATION_YEARS * 365)
