...
import FoundationBacktestPanel from '../../components/backtesting/FoundationBacktestPanel';
...
const BASE_PATH = '/backtesting/foundation';
...
export default function FoundationPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-100">Foundation Models</h1>
        <p className="text-slate-400 text-sm mt-1">
          Zero-shot time-series forecasting with TimesFM and Chronos. Walk-forward backtests are
          separate from ML classification — no training step required.
        </p>
      </div>
      ...
      {symbol ? (
        ...
        <div className="text-center py-16 text-slate-500 text-sm border border-dashed border-slate-800 rounded-lg">
          Search ingested stocks or ETFs to run a foundation-model walk-forward backtest.
        </div>
      )}
    </div>
  );
