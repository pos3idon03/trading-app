...
import MlTestingWorkspace from '../../components/backtesting/ml-testing/MlTestingWorkspace';
...
const BASE_PATH = '/backtesting/ml-testing';
...
export default function MlTestingPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-100">ML Testing</h1>
        <p className="text-slate-400 text-sm mt-1">
          Trial-and-error ML backtests: pick asset, periods, feature mode, model, and labels; run
          multiple experiments and compare results without the full ML wizard gates.
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-end gap-4">
        <InstrumentSearch
          ...
          placeholder="Search ingested instruments"
        />
      ...
      {symbol ? (
        ...
        <div className="text-center py-16 text-slate-500 text-sm border border-dashed border-slate-800 rounded-lg">
          Search an instrument to start ML testing experiments.
        </div>
      )}
    </div>
  );
